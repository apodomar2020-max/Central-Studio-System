...
| Operational failure rehearsal | Satisfied | G1R closure report and commit `07b9369` | engineering_owner | Yes |
...
| Approval tooling | Satisfied | G2A schema, validator and tests | engineering_owner | Yes |
| Human decisions | Pending | ID-01 through ID-12 are blank | All required roles | Yes |
| Backup evidence | Pending | Template only; no completed evidence | database_operator, finance_owner | Yes |
| Restore evidence | Pending | Template only; no completed evidence | database_operator, engineering_owner | Yes |
...
| Production inspection authorization | Not authorized | G2B template defaults denied | engineering_owner, security_or_data_owner, database_operator, release_operator | Yes |
| Production inspection | Not executed | Future separately authorized Phase G2B | engineering_owner, security_or_data_owner | Yes |
