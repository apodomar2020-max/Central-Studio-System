...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Inter_400Regular", color: "#9CA3AF", lineHeight: 21 },
  errorBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  suggestionText: { fontSize: 12, fontFamily: "Inter_500Medium", color: colors.studio.primary },
  typeList: { gap: 10 },
  typeCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  typeTitle: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#FFFFFF" },
  typeSubtitle: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#6B7280", marginTop: 2 },
});
