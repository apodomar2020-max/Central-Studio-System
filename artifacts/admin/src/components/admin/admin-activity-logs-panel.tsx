/**
 * Admin Activity Logs panel — System → Logs → Admin Activity tab (Wave 5).
 *
 * Extracted verbatim from the original logs.tsx (Phase 7B) with zero
 * behavior change — same GET /api/admin/logs endpoint, same filters, same
 * details Sheet, same auditLogs.view gate. logs.tsx now hosts this
 * alongside the new Notification Delivery panel as two distinct tabs
 * (never a merged table — admin_activity_logs and notification_delivery_logs
 * are different domains: who changed what in Admin vs. operational Push
 * delivery outcomes).
 */
