 ...
 * Postgres database already migrated through 0072 (the full chain, run via
 ...
 * Expand-compatibility scenario (applying 0072 on top of pre-existing
...
test('0072 final schema has nullable canonical relationships and is_legacy, and keeps legacy joins', () => {
  assert.equal(query(`
